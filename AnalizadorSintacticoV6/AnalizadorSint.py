...
blank_var = "#include <iostream> using namespace std; int main() { int i = 1;     int j = 2; float v; float x; float a[100]; while (i<2) {i = i+ 1; }return 0; }"
...
class parser:
    ...
    def function(self):
        ...
        if(self.lookahead.data['TYPE'] == 'IDENTIFIER'):
            ...
            print("ERROR EN LA SINTAXIS DE LA FUNCION: ",self.lookahead.data)
            exit()
    def stmtlist(self):
        data = self.lookahead.data['value'];
    ...
    def paraid_(self):
        ...
        if(data == '['):
            ...
            print("ERROR EN PARAMETROS DIFERENTES: ", self.lookahead.data)
            exit()
